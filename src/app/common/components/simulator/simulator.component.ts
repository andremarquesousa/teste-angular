...
export class SimulatorComponent {
  ...
  monthsList = [{ value: '', name: 'Selecione meses' }, { value: '2', name: '2 meses' }, { value: '3', name: '3 meses' }, { value: '4', name: '4 meses' }, { value: '5', name: '5 meses' }, { value: '6', name: '6 meses' }, { value: '12', name: '12 meses' }, { value: '24', name: '8 meses' }, { value: '36', name: '36 meses' }];
  result:number = 0;
  tax = 0;
  ...
  handleSimulator() {
    ...
    this.tax = lastValue * (22.5 / 100) / 12;
